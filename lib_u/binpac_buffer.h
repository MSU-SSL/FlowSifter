...
public:
	...
	FlowBuffer(LineBreakStyle linebreak_style = STRICT_CRLF);
	virtual ~FlowBuffer();
...
public:
	...
	{
		return line_length;
		//return expected_end - data_begin;
	}
	...
	inline void TestOneline(){
		if (/*data_begin < expected_end ||*/
			(data_begin < orig_end && *data_begin != CR && *data_begin!=LF))	{
